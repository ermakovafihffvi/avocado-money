    ...
    public function addMoving(){
        $this->table->insert([
            [
                ...
                'created_at' => Carbon::createFromDate("2020", "06", "28")
            ],
            [
                'source_id' => $this->sourceSaved, 
                'sum' => 13326, 
                'category_id' => $this->catMoving, 
                'created_at' => Carbon::createFromDate("2020", "07", "23")
            ],
            [
                'source_id' => $this->sourceSaved, 
                'sum' => 8222, 
            ...
            [
                ...
                'sum' => 61.64, 
                'category_id' => $this->catMoving, 
                'created_at' => Carbon::createFromDate("2020", "07", "27")
            ],
            [
                'source_id' => $this->sourceSaved, 
                'sum' => 13013, 
                'category_id' => $this->catMoving, 
                'created_at' => Carbon::createFromDate("2020", "08", "21")
            ],
            [
                'source_id' => $this->sourceProcent, 
                'sum' => 931.20, 
                'category_id' => $this->catMoving, 
                'created_at' => Carbon::createFromDate("2020", "07", "31")
            ],
            [
                'source_id' => $this->sourceSaved, 
                'sum' => 25500, 
                'category_id' => $this->catMoving, 
                'created_at' => Carbon::createFromDate("2020", "09", "21")
            ],
            [
                'source_id' => $this->sourceSaved, 
                'sum' => 20183, 
                'category_id' => $this->catMoving, 
                'created_at' => Carbon::createFromDate("2020", "10", "22")
            ],
            [
                'source_id' => $this->sourceProcent, 
                'sum' => 896.41, 
                'category_id' => $this->catMoving, 
                'created_at' => Carbon::createFromDate("2020", "09", "30")
            ],
            [
                'source_id' => $this->sourceProcent, 
                'sum' => 879.25, 
                'category_id' => $this->catMoving, 
                'created_at' => Carbon::createFromDate("2020", "08", "31")
            ],
            [
                'source_id' => $this->sourceProcent, 
                'sum' => 994.18, 
                'category_id' => $this->catMoving, 
                'created_at' => Carbon::createFromDate("2020", "10", "31")
            ],
            [
                'source_id' => $this->sourceSaved, 
                'sum' => 30000, 
            ...
            [
                ...
                'sum' => 30000, 
                'category_id' => $this->catMoving, 
                'created_at' => Carbon::createFromDate("2020", "12", "21")
            ],
            [
                'source_id' => $this->sourceProcent, 
                'sum' => 1057.84               , 
    ...
    public function addUnexpected(){
        $this->table->insert([
            ...
            [
                ...
                'sum' => 52.88, 
                'category_id' => $this->catUnexpected, 
                'created_at' => Carbon::createFromDate("2020", "09", "03")
            ],
            [
                'source_id' => $this->sourceSaved, 
                'sum' => 4100, 
            ...
            [
                ...
                'sum' => 70.59, 
                'category_id' => $this->catUnexpected, 
                'created_at' => Carbon::createFromDate("2020", "10", "03")
            ],
            [
                'source_id' => $this->sourceProcent, 
                'sum' => 94.62, 
                'category_id' => $this->catUnexpected, 
                'created_at' => Carbon::createFromDate("2020", "11", "02")
            ],
            [
                'source_id' => $this->sourceProcent, 
                'sum' => 111.84, 
                'category_id' => $this->catUnexpected, 
                'created_at' => Carbon::createFromDate("2020", "12", "03")
            ],
            [
                'source_id' => $this->sourceSaved, 
                'sum' => 4100, 
    ...
    public function addBigExp(){
        $this->table->insert([
            ...
            [
                ...
                'sum' => 647.16, 
                'category_id' => $this->catBigExp, 
                'created_at' => Carbon::createFromDate("2020", "08", "27")
            ],
            [
                'source_id' => $this->sourceProcent, 
                'sum' => 594.9, 
                'category_id' => $this->catBigExp, 
                'created_at' => Carbon::createFromDate("2020", "09", "27")
            ],
            [
                'source_id' => $this->sourceProcent, 
                'sum' => 569.1, 
                'category_id' => $this->catBigExp, 
                'created_at' => Carbon::createFromDate("2020", "10", "27")
            ],
            [
                'source_id' => $this->sourceSaved, 
                'sum' => 1097, 
            ...
            [
                ...
                'sum' => 3277, 
                'category_id' => $this->catBigExp, 
                'created_at' => Carbon::createFromDate("2020", "11", "25")
            ],
            [
                'source_id' => $this->sourceSaved, 
                'sum' => 16983, 
            ...
            [
                ...
                'sum' => 535.27, 
                'category_id' => $this->catBigExp, 
                'created_at' => Carbon::createFromDate("2020", "11", "27")
            ],
        ]);
    }
